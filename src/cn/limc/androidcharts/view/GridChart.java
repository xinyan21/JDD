...
public class GridChart extends BaseChart implements ITouchEventNotify,
	 ...
	 * 
	 * @see
	 * cn.limc.cn.limc.androidcharts.event.ITouchEventNotify#addNotify(ITouchEventResponse
	 * )
	 */
	 ...
	 * @param event
	 * 
	 * @see cn.limc.cn.limc.androidcharts.event.ITouchEventNotify#removeNotify(int)
	 */
	 ...
	 * @param event
	 * 
	 * @see cn.limc.cn.limc.androidcharts.event.ITouchEventNotify#removeNotify()
	 */
