...
public class CharacterParser {
    public static String[] sPYStringArray = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    private static int[] sPYValueArray = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    private static CharacterParser sInstance = new CharacterParser();
    ...
    public String convert(String str) {
        ...
        if (ascii > 0 && ascii < 160) {
            ...
            for (int i = (sPYValueArray.length - 1); i >= 0; i--) {
                if (sPYValueArray[i] <= ascii) {
                    result = sPYStringArray[i];
                    break;
                }
            }
        }
