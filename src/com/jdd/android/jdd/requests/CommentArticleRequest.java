 ...
 * @since 1.0
 */
public class CommentArticleRequest implements CallBack.SchedulerCallBack {
    ...
    public CommentArticleRequest(
            String url, int taskId, String cmtType, Parameter parameter, ResponseAction action) {
