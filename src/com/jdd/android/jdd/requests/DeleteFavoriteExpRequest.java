 ...
 * @since 1.0
 */
public class DeleteFavoriteExpRequest extends PushRequest {
    public DeleteFavoriteExpRequest(int taskId, Parameter parameter, ResponseAction action) {
        super(taskId, parameter, action);
        ProjectUtil.addPlatformFlag(parameter);
        mUrl = ProjectUtil.getFullMainServerUrl("URL_DELETE_FAVORITE_EXPS");
    }
