 ...
 * @since 1.0
 */
public class QueryRankRequest implements CallBack.SchedulerCallBack {
    ...
    public QueryRankRequest(int taskId, Parameter parameter, ResponseAction action) {
    ...
    public void handler(MessageAction messageAction) {
        String url = ProjectUtil.getFullPriceUrl("URL_QUERY_RANK");
        ...
        if (null != bytes) {
            ...
            try {
                ...
                if (1 == jsonResult.optInt("code")) {
                    JSONArray arrayResult = jsonResult.optJSONObject("result").optJSONArray("codes");
