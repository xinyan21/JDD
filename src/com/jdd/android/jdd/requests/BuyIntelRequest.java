 ...
 * @since 1.0
 */
public class BuyIntelRequest implements CallBack.SchedulerCallBack {
    ...
    public BuyIntelRequest(int taskId, Parameter parameter, ResponseAction action) {
    ...
    public void handler(MessageAction messageAction) {
        String url = ProjectUtil.getFullMainServerUrl("URL_BUY_INTEL");
