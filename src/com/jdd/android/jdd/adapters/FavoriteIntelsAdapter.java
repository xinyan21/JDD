 ...
 * @since 1.0
 */
public class FavoriteIntelsAdapter extends BaseAdapter {
    private List<ArticleEntity> mEntities;
    private FavoritesActivity mActivity;

    public FavoriteIntelsAdapter(FavoritesActivity activity, List<ArticleEntity> entities) {
        mEntities = entities;
        mActivity = activity;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(mActivity).inflate(
                    R.layout.lv_item_favorite_intel, null);
