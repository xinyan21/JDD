...
public class HttpRequest {
    ...
    public byte[] post(String url, Parameter params) {
        ...
        try {
            ...
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "请求URL:  " + url + "参数: " + params);
            ...
            if (this.responseCode == 200) {
                ...
                for (int i = 0; i < cookies.size(); i++) {
                    if ("JSESSIONID".equals(cookies.get(i).getName())) {
                        sJSessionId = cookies.get(i).getValue();
                        break;
                    }
                }
            } else {
            ...
            try {
                ...
                Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "", var11);
            }

            request.abort();
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "HttpRequest.post", var11);
        } catch (SocketTimeoutException var12) {
            try {
                result = "{\"error_info\":\"请求数据超时,请检查网络或服务是否运行正常.\",\"error_no\":\"-111\"}".getBytes(this.charset);
            } catch (UnsupportedEncodingException var9) {
                Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "", var12);
            }

            request.abort();
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "HttpFactory.post", var12);
        } catch (Exception var13) {
            try {
                result = "{\"error_info\":\"框架内部错误!.\",\"error_no\":\"-119\"}".getBytes(this.charset);
            } catch (UnsupportedEncodingException var8) {
                Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "", var13);
            }

            request.abort();
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, com.thinkive.adf.invocation.http.HttpRequest.class + "HttpFactory.post", var13);
        }
    ...
    public byte[] get(String url, Parameter params) {
        Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class.getName() + "进入同步get()");
        ...
        try {
            if (params != null && !params.isEmpty()) {
                ...
                Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class.getName() + "[" + url + "?" + e11 + "]");
                Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class.getName() + "[" + request.getURI() + "]");
            } else {
            ...
            request.abort();
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "HttpRequest.GET", var11);
        } catch (SocketTimeoutException var12) {
            try {
                result = "{\"error_info\":\"请求数据超时,请检查网络或服务是否运行正常.\",\"error_no\":\"-111\"}".getBytes(this.charset);
            } catch (UnsupportedEncodingException var9) {
            ...
            request.abort();
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "HttpFactory.GET", var12);
        } catch (Exception var13) {
            try {
                result = "{\"error_info\":\"框架内部错误!.\",\"error_no\":\"-119\"}".getBytes(this.charset);
            } catch (UnsupportedEncodingException var8) {
            ...
            request.abort();
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, com.thinkive.adf.invocation.http.HttpRequest.class + "HttpFactory.GET", var13);
        }
    ...
    public String uploadTo(String url, Parameter args, ResponseCallBack callBack) {
        ...
        try {
            ...
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "HttpFactory.uploadFile", var12);
            httpPost.abort();
        }
    ...
    public Bitmap getBitmapFromUrl(String imgUrl) {
        ...
        try {
            ...
            Logger.info(com.thinkive.adf.invocation.http.HttpRequest.class, "HttpFactory.post", var14);
            request.abort();
        } finally {
            try {
                if (is != null) {
