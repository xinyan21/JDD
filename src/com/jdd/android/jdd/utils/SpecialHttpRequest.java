 ...
 * @corporation
 * @date 2016-03-08
 * @last_edit 2016-03-08
 * @since 1.0
 */
public class SpecialHttpRequest {
    private String charset = "UTF-8";
    private int responseCode = -1;
    private DefaultHttpClient httpClient = null;

    public SpecialHttpRequest() {
...
//        request.setHeader("Content-Type", "text/html;charset=UTF-8");
        ...
        try {
            ...
            Logger.info(HttpRequest.class, "请求URL:  " + url + "参数: " + params);
            ...
            try {
                ...
                Logger.info(HttpRequest.class, "", var12);
            }

            request.abort();
            Logger.info(HttpRequest.class, "HttpFactory.post", var12);
        } catch (Exception var13) {
            try {
                result = "{\"error_info\":\"框架内部错误!.\",\"error_no\":\"-119\"}".getBytes(this.charset);
            } catch (UnsupportedEncodingException var8) {
                Logger.info(HttpRequest.class, "", var13);
            }

            request.abort();
            Logger.info(HttpRequest.class, HttpRequest.class + "HttpFactory.post", var13);
        }
    ...
    public byte[] get(String url, Parameter params) {
        Logger.info(HttpRequest.class.getName() + "进入同步get()");
        ...
        try {
            if (params != null && !params.isEmpty()) {
                ...
                Logger.info(HttpRequest.class.getName() + "[" + url + "?" + e11 + "]");
                Logger.info(HttpRequest.class.getName() + "[" + request.getURI() + "]");
            } else {
            ...
            try {
                ...
                Logger.info(HttpRequest.class, "", var11);
            }

            request.abort();
            Logger.info(HttpRequest.class, "HttpRequest.GET", var11);
        } catch (SocketTimeoutException var12) {
            try {
                result = "{\"error_info\":\"请求数据超时,请检查网络或服务是否运行正常.\",\"error_no\":\"-111\"}".getBytes(this.charset);
            } catch (UnsupportedEncodingException var9) {
            ...
            request.abort();
            Logger.info(HttpRequest.class, "HttpFactory.GET", var12);
        } catch (Exception var13) {
            try {
                result = "{\"error_info\":\"框架内部错误!.\",\"error_no\":\"-119\"}".getBytes(this.charset);
            } catch (UnsupportedEncodingException var8) {
            ...
            request.abort();
            Logger.info(HttpRequest.class, HttpRequest.class + "HttpFactory.GET", var13);
        }
